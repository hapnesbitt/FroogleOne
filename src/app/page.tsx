...
export default function HomePage() {
  ...
  const fetchBatches = useCallback(async () => { // Wrapped in useCallback
  ...
  const checkAuthStatus = useCallback(async () => { // Wrapped in useCallback
    try {
  ...
  }, [fetchBatches, getAuthStatus]); // Dependencies for useCallback
      ...
      <div className="flex items-center justify-center min-h-screen-centered bg-gray-100 p-4">
        <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md border border-gray-200">
          ...
          <p className="text-center text-gray-600 text-sm mt-6">
            Do not have an account?{' '} {/* Escaped quote */}
